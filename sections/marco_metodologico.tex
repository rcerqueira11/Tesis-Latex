...
\subsection{RUP}
 ...
 \cite{rupbib} establece que RUP es un proceso para el desarrollo de un proyecto de software que define claramente quien, cómo, cuándo y qué debe hacerse en el proyecto, con 3 características esenciales, está dirigido por:
...
\end{center}
\caption{Proceso RUP. (Tomada de \citet{dtyocimgbib})}
\label{fig:Rup}
\end{figure}
...
\cite{cascadabib} define el Modelo en Cascada, también llamado Lineal secuencial, como aquel cuyo enfoque metodológico ordena rigurosamente las etapas del proceso para el desarrollo de software, de tal forma que el inicio de cada etapa debe esperar a la finalización de la etapa anterior. 
...
\end{center}
\caption{Proceso Cascada. (Tomada de \citet{cascadaimgbib})}
\label{fig:Casacada}
\end{figure}
...
\cite{scrumbib} establecen que el Scrum es un proceso de la Metodología Ágil que se usa para minimizar los riesgos durante la realización de un proyecto, pero de manera colaborativa. 
...
\end{center}
\caption{Proceso Scrum. (Tomada de \citet{scrumimgbib})}
\label{fig:Scrum}
\end{figure}
...
\end{center}
\caption{Proceso Scrum. (Tomada de \citet{xpibib})}
\label{fig:xp}
\end{figure}
